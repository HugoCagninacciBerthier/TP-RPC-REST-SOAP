...
### REST :
Utilisateur                  API REST (Flask)                Base de données (CSV)
     |                              |                                  |
     | Requête HTTP GET             |                                  |
     |----------------------------->|                                  |
     | URL: /siren/<siren_id>       |                                  |
     |                              | Recherche du SIREN dans le CSV   |
     |                              |--------------------------------->|
     |                              |                                  |
     |                              | Résultat trouvé                  |
     |                              |<---------------------------------|
...
Utilisateur                  API SOAP (Flask)                Base de données (CSV)
     |                              |                                  |
     | Requête SOAP HTTP POST       |                                  |
     |----------------------------->|                                  |
     | URL: /soap                   |                                  |
     | Body:                        |                                  |
     | <soap:Envelope>              |                                  |
     ...
     |     <GetSirenResponse>       |                                  |
     |       <Année>2024</Année>    |                                  |
     |       <Raison_Sociale>XYZ</Raison_Sociale>|                     |
     |     </GetSirenResponse>      |                                  |
     |   </soap:Body>               |                                  |
     | </soap:Envelope>             |                                  |
     |                              |                                  |
     ...
     |   <faultstring>SIREN not found</faultstring>|                   |
     | </soap:Fault>                |                                  |


### RPC :
Utilisateur                  API RPC (Flask)                Base de données (CSV)
     |                              |                                  |
     | Requête JSON-RPC HTTP POST   |                                  |
     |----------------------------->|                                  |
     | URL: /api                    |                                  |
     | Body:                        |                                  |
     | {                            |                                  |
